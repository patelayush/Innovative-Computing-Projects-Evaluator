...
public class Scoreboard extends Fragment {
    ...
    private ArrayList<SubmittingResponse> scores;
    public Scoreboard() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Call<ArrayList<SubmittingResponse>> call = restapi.getallscores();
        call.enqueue(new Callback<ArrayList<SubmittingResponse>>() {
            @Override
            public void onResponse(Call<ArrayList<SubmittingResponse>> call, Response<ArrayList<SubmittingResponse>> response) {
                if (response.isSuccessful() && response.body() != null) {
                    ...
                    Collections.sort(scoreboarddata,new CustomComparator());
                    ScoreAdapter myAdapter = new ScoreAdapter(scoreboarddata);
    ...
    public class CustomComparator implements Comparator<ScoreboardData> {
        @Override
        public int compare(ScoreboardData o1, ScoreboardData o2) {
